...
// A strategy is a function that takes a score as input and returns an action to perform. (Remember, an action is itself a function.)
...
// Among these strategies, staying at 25 is best, but the optimal strategy for Pig is much more complex: https://www.google.com/search?q=optimal+play+pig
